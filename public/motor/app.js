...
import { initPhotos, autoResizeNotes, initDraftInputs, renderPreview, resizeNotes, createPdfImage, createPreviewImage } from "./photos.js";
...
async function restoreDraft(){
  ...
  state.previewPhotos=await Promise.all(state.selectedPhotos.map(createPreviewImage));
  renderPreview();
  setWorkState();
  renderProgress();
