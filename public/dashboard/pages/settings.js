...
export async function initSettings(){
    ...
    const jobcardLabels = [t("title","Tittel"),t("jobcardSuggestedInterval","Foreslått intervall"),t("jobcardAutoInterval","Automatisk intervall"),t("jobcardManualInterval","Manuelt intervall"),"SJA",t("jobcardVisibility","Synlighet")];
