...
export async function initSettings(){
    ...
    container.innerHTML = `<div class="settings-page"><header class="settings-page-header"><h1>${t("settings","Innstillinger")}</h1><p>${t("settingsLandingDescription","Administrer innstillinger for konto og jobbkort.")}</p></header>${section("account",t("personalAccount","Personlig konto"),t("personalAccountDescription","Navn og adgangskode."),"user",accountContent())}${section("documents",t("jobcardDocumentsTitle","Vedlegg til jobbkort"),t("jobcardDocumentsShort","Dokumenter og knapper på jobbkort."),"document",documentsContent())}${canManageAssignments ? section("assignments",t("fixedAssignments","Faste tildelinger"),t("fixedAssignmentsShort","Ansvarlig, medhjelper og påminnelser."),"user",assignmentsContent()) : ""}${section("jobcards",t("jobcards","Jobbkort"),t("jobcardsSettingsShort","Intervall og synlighet."),"jobcard",jobcardsContent())}</div>`;
    ...
    const openAssignmentModal = (assignment) => {
        ...
        auto.addEventListener("change", () => { manual.disabled = auto.checked; });
