...
export async function initDashboard(){
  ...
  const overdueCards=jobcards.filter(item=>isOverdue(item)).sort((left,right)=>String(left.nextExecution).localeCompare(String(right.nextExecution)));
