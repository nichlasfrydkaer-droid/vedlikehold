...
function openShareDialog({item,url,type}){
    ...
    dialog.querySelector("[data-email]").addEventListener("click",()=>{deadline.hidden=false;input.focus();});
